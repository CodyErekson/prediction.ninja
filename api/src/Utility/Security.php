<?php
//static class containing all security/password related functions
...
class Security {
    ...
    public static function redirectToLogin($loginPage, $currPage=true){
    ...
    public static function register($name, $username, $email, $password, $verification){
        ...
        return self::login($username, $password, false, $_SERVER['REMOTE_ADDR']);
    }

    public static function changePassword($username, $password, $verification){
    ...
    public static function login($username, $password, $remember, $ip=NULL) {
        ...
        if ( self::validate_password($password, $creds['password']) ){
            ...
            $c = NULL;
            if ( $remember == "true" ){
                $c = $creds['username'] . ":" . self::getSessionToken();
    ...
    public static function debugLogin($ips) {
        ...
        if ( in_array($_SERVER['REMOTE_ADDR'], $splt) ){ //our IP is in the allowed list
            ...
            $_SESSION['token'] = $token;
            $_SESSION['logged_in'] = true;
            $c = $u['username'] . ":" . self::getSessionToken();
